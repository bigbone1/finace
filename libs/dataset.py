...
class HighFreqDataset(Dataset):
    ...
    def _init_dataset(self):
        ...
        sql = 'select * from stock_zh_5_minute where date between "{}" and "{}"'.format(self.start_date, self.end_date)
        ...
        self.data = torch.from_numpy(feat).float()
...
if __name__ == '__main__':
    ...
    dataset = HighFreqDataset('2024-06-01', '2024-12-31', save=True)
